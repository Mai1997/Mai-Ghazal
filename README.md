...
git clone https://github.com/Mai1997/Mai-Ghazal.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf Mai-Ghazal && rm -rf .telegram-cli && git clone https://github.com/Mai1997/Mai-Ghazal.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
